...
while($row = mysqli_fetch_array($sql2)){
    if($row['predmet'] == $predmet && $row['tim'] == $word){
        $sql = "UPDATE ULOHA2BODY SET body='$body' WHERE predmet='$predmet' AND tim='$word'";
...
$sql = "INSERT INTO ULOHA2BODY (predmet, tim,body,suhlas_admin)
        VALUES ('$predmet', '$word', '$body','')";
