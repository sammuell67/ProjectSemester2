...
<div class="pad">
    <div class="col text-center">
      <a href="uloha2_index.php" class="btn btn-info" role="button">Login from DB</a>
...
<form method="post"  action="uloha2_LDAP.php">
    <div class="box">
        ...
        <input type="text"  name="username" placeholder="LDAP logon" class="email" />

        <input type="password" name="password" placeholder="Password" class="email" />


        <input type="submit" class="btn" name="LDAP_btn" value="Sign in">
